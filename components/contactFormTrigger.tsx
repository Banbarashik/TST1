    ...
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className="bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid max-w-screen translate-x-[-50%] translate-y-[-50%] gap-4 overflow-x-hidden overflow-y-hidden rounded-lg border shadow-lg duration-200 lg:w-full lg:max-w-xl"
        >
          <VisuallyHidden>
