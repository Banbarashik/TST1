    ...
    <>
      ...
      <section>
        ...
        <ProductParagraph>
          ...
          которые, в отличие от водяных моделей, изготавливаются без
          разделительных сегментов.
        </ProductParagraph>
        <ProductParagraph>
          ...
          одноходового воздухонагревателя КПСк. Съемные боковые щитки крепятся с
          помощью болтового соединения к торцам трубных решеток. Для соединения
          парового калорифера КПСк со смежным оборудованием
        ...
        <ProductParagraph>
          ...
          Для подачи пара и отвода конденсата используются патрубки, монтируемые
          в каждый из коллекторов.
        </ProductParagraph>
      </section>
