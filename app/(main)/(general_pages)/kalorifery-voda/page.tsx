    ...
    <>
      ...
      <section className="space-y-6">
        ...
        <section>
          <Heading
            lvl={2}
            text="Онлайн-расчет температуры воздуха на выходе из водяного калорифера"
          />
          <ProductParagraph className="mb-3">
            В поля калькулятора вносятся следующие показатели: 1. объем
            нагреваемого воздуха, 2. температура воздуха на входе в калорифер,
            3. мощность подобранного водяного воздухонагревателя вентиляции. По
        ...
        <ProductParagraph>
          ...
          расходу теплоносителя. Подробный расчет и подбор водяных калориферов
          для приточной вентиляции представлен серией инженерных калькуляторов с
          тепловыми, гидравлическими и аэродинамическими показателями.
        </ProductParagraph>
      </section>
