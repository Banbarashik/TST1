...
export const productData: Product[] = [
  ...
  },
  {
    ...
    metadata: {
      ...
      keywords:
        "калорифер 572 572,калорифер кск 572 572,калорифер водяной 572 572,калорифер водяной кск 572 572,калорифер приточный 572 572,калорифер водяной приточный 572 572,калорифер 572 572 технические характеристики,калорифер кск 572 572 расчет и подбор,приточный калорифер 572 572 производительность по воздуху 2500,водяной калорифер 500 500",
    },
    headers: [
      "Калькулятор подбора калорифера КСк 572х572",
    ...
    variants: [
      {
        id: "ksk-572x572-2",
        name: "Приточный калорифер КСк 572x572_2",
        heatPower: 26,
        price: 13093,
      },
      {
        id: "ksk-572x572-3",
        name: "Приточный калорифер КСк 572x572_3",
        heatPower: 34,
        price: 17548,
      },
      {
